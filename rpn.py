...
rootdir='/home/yang/下载/VOCdevkit/VOC2012/Annotations'
...
for i in range(0,len(list)):
    ...
    filepath="/home/yang/下载/VOCdevkit/VOC2012/JPEGImages/"+filename
...
loss=tf.nn.softmax_cross_entropy_with_logits_v2(logits=conv_rpn,labels=y_out)
